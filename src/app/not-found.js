export default function NotFound() {
  return (
    <>
      <div className="h-126 flex items-center justify-center">
        <div className="mt-20 flex flex-col items-center justify-center">
          <div className="w-20 h-20 rounded-full bg-[#f27405] -z-1 ml-0 -mb-24 border-2">
          ...
          <div className="tv">
            <div className="cruve">
              <svg className="curve-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 189.929 189.929" xmlSpace="preserve">
